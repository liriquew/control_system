...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in predictions_service/predictions_service_pb2_grpc.py depends on'
...
def add_PredictionsServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'predictions.Predictions', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('predictions.Predictions', rpc_method_handlers)
